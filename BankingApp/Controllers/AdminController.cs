...
using static BankingApp.Models.Account;
...
namespace BankingApp.Controllers
{
    public class AdminController : Controller
    {
        ...
        public Account GetCurrentAccountFromAccountNumber(string accountNumber)
        {
            return db.Accounts.Where(x => x.User.AccountNumber == accountNumber && x.AccountType == (byte)EAccountType.Current).FirstOrDefault();
        }
