...
function integrateWasmJS() {
  ...
  function getBinaryPromise() {
    ...
    if (!Module['wasmBinary'] && (false) && typeof fetch === 'function') {
...
FS.staticInit();__ATINIT__.unshift(function() { if (!Module["noFSInit"] && !FS.init.initialized) FS.init(); });__ATMAIN__.push(function() { FS.ignorePermissions = false; });Module["FS_createFolder"] = FS.createFolder;Module["FS_createPath"] = FS.createPath;Module["FS_createDataFile"] = FS.createDataFile;Module["FS_createPreloadedFile"] = FS.createPreloadedFile;Module["FS_createLazyFile"] = FS.createLazyFile;Module["FS_createLink"] = FS.createLink;Module["FS_createDevice"] = FS.createDevice;Module["FS_unlink"] = FS.unlink;__ATINIT__.unshift(function() { });{ var fs = require("fs"); var NODEJS_PATH = require("path"); NODEFS.staticInit(); }DYNAMICTOP_PTR = staticAlloc(4);
